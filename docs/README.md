...
| [`e8450-upstream-roadmap-2026-09.md`](e8450-upstream-roadmap-2026-09.md) | Current vendor-SDK/upstream roadmap: mt76 pin-bump evaluation past `6d1c6a75`, the WED-20 busy-poll A/B, PS-buffering and physical acceptance tests still open, and the explicitly-excluded/closed list carried forward (MCU firmware limitation, WED-16, cache-line audit, DMA ring depth). |
